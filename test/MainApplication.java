...
public class MainApplication {
    ...
    public MainApplication() {
        ...
        data = movieLibrary.getMoviesTabled(movieLibrary.getAllMovies());
    ...
    public void showMovieTable(){
        MovieTable movieTable = new MovieTable(this, movieLibrary.getMoviesTabled(movieLibrary.getAllMovies()), "all");
